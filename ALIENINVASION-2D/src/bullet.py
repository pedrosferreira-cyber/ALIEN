...
class Bullet(Sprite):
    ...
    def __init__(self, alien_invasion_screen: Surface, alien_invasion_settings: Settings, alien_invasion_ship: Ship) -> None:
        ...
        self.y = int(self.rect.y) # Armazena a posição vertical do projétil como um número de ponto flutuante para permitir movimentos suaves
